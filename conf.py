...
htmlhelp_basename = 'DaskExamplesdoc'
...
latex_documents = [
    (master_doc, 'DaskExamples.tex', 'Dask Examples Documentation',
...
man_pages = [
    (master_doc, 'daskexamples', 'Dask Examples Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DaskExamples', 'Dask Examples Documentation',
     author, 'DaskExamples', 'One line description of project.',
     'Miscellaneous'),
]
